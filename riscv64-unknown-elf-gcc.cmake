...
set(FLAGS                           "-march=rv32imac -mabi=ilp32 -fdata-sections -ffunction-sections -Wl,--gc-sections ")
...
set(CMAKE_EXE_LINKER_FLAGS   "-T${linker_script_SRC} ${CPU_PARAMETERS} -Wl,-Map=${CMAKE_PROJECT_NAME}.map --specs=nosys.specs --enable-multilib -u _printf_float -Wl,--start-group -lc -lm -lstdc++ -lsupc++ -Wl,--end-group -Wl,--print-memory-usage")
