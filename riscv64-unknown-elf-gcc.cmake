...
if( NOT C_FLAGS_INITIALIZED )
    ...
    string(APPEND CMAKE_EXE_LINKER_FLAGS       "-T${linker_script_SRC} ${CPU_PARAMETERS} -Wl,-Map=${CMAKE_PROJECT_NAME}.map -u _printf_float -Wl,--end-group -Wl,--print-memory-usage")
...
set(symbols_SYMB
    ...
    "portasmHANDLE_INTERRUPT=externalInterruptHandler"
...
set(CMAKE_C_FLAGS            "${CPU_PARAMETERS} -Wall -Wextra -Wpedantic -Wno-unused-parameter -Og -g3 -ggdb3")
set(CMAKE_CXX_FLAGS          "-fno-rtti -fno-exceptions -fno-threadsafe-statics")
set(CMAKE_EXE_LINKER_FLAGS   "-T${linker_script_SRC} ${CPU_PARAMETERS} -Wl,-Map=${CMAKE_PROJECT_NAME}.map --specs=nosys.specs -nostartfiles -u _printf_float -Wl,--print-memory-usage") #-Wl,--start-group -lc -lm -lstdc++ -lsupc++ -Wl,--end-group 
#set(CMAKE_C_FLAGS_DEBUG     "-g -DDEBUG")
